/**
 ...
 UPDATED: working on simplifying it, removing easyXDM (because now have CORS).

 * note-o-rama, second attempt
 * Copyright (c) 2011 Stephen A. Butterfill
 *
 * UPDATES for firefox extension: changed http://note-o-rama.com to https://noteorama.iriscouch...
 *    and xdm changed to provider.debug.html.
 *
...
(function(exports){
    ...
    exports._make_settings = function(nrama_uuid, use_localhost, lib){
        var settings = {
            ...
            xdm_url: ( use_localhost ?
                     ...
                     :
                        'https://noteorama.iriscouch.com/nrama/_design/nrama/_rewrite/xdm/provider.debug.html'
                        // changed this to debug --- nb if going back to provider.html, note that baseurl setting is wrong for noteorama.iriscouch.com as this needs full thing
                     ),
    ...
    /**
     TODO: should probably get rid of this and refactor everything to use the pouchdb API
     (maybe use pouchDB directly --- who is listening to the events triggered?)
    
     * @return a wrapped subset of kanso's 0.0.7 db module, same API
     * specifically, it implements:
     *  - saveDoc(doc, callback)
     *  - removeDoc(doc, callback)
     *  - getView(name, query, callback)
     *  - doUpdate(doc, callback) --- i added this, see db.ex-kanso.js
        ...
        if( typeof _NRAMA_BKMRKLT === 'undefined' && typeof require !== 'undefined' ) {
            ...
            if( typeof _NRAMA_BKMRKLT === 'undefined' || !_NRAMA_BKMRKLT ) {
                ...
                var lib_url = (  use_localhost ?
                                ...
                                :
                                    "https://noteorama.iriscouch.com/nrama/_design/nrama/_rewrite/bkmrklt/lib.min.js"
                              );
